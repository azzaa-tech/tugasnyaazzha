...
<div className="bg-gray-100 h-full">
      <div className="bg-blue-950 flex items-center justify-between w-full h-15">
          ...
          <div className="flex items-center w-auto gap-3">
            ...
            <div className="w-auto gap-2 flex">
              ...
              <div className="gap-3 w-auto">
                <h1 className="text-white">Salsabila Al-zahir</h1>
              </div>
            </div>
      ...
      <div className="p-3 h-auto w-auto space-y-5">
        <h3 className="font-extrabold text-blue-950 text-xl ml-5">
          ...
          <div className="space-y-5">
            <div className=" bg-white h-20 w-80 flex">
              ...
              <div className="flex-col pl-5 pt-2 space-y-1">
                <p className="text-xs text-black block">MASSAGES</p>
                <p className="font-bold text-black text-md">1,410</p>
              </div>
            </div>
          ...
          <div className="space-y-5">
            <div className=" bg-white h-20 w-80 flex">
              ...
              <div className="flex-col pl-5 space-y-1 pt-2">
                <p className="text-xs text-black block">BOOKMARKS</p>
                <p className="font-bold text-black text-md">410</p>
              </div>
            </div>
